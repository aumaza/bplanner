		...
		echo '<div class="container">
				   ...
				   <form id="fr_new_user_ajax" method="POST" enctype="multipart/form-data">
				    ...
				    <div class="form-group">
				      ...
				      <input type="text" class="form-control" id="celular" name="celular" maxlength="10" placeholder="Ingrese su Número de Celular. Ej.: 1166667777">
				    </div>
...
*/
public function addRegestry($oneRegestry,$name,$email,$celular,$password_1,$password_2,$file,$task,$dbname,$conn){
	...
	if($conn){
		...
		if(((strlen($password_1) >= 10) && (strlen($password_1) <= 15)) && ((strlen($password_2) >= 10) && (strlen($password_2) <= 15))){
			...
			if((strcmp($password_2,$password_1) == 0)){
                ...
                $sql = "select * from bp_usuarios where email = '$email' or nombre = '$name'";
									        ...
									        $sql_1 = "INSERT INTO bp_usuarios ".
									                ...
									                "VALUES ".
									                  "($oneRegestry->setName('$name'),
									            		...
									            		$oneRegestry->setEmail('$email'),
									            		$oneRegestry->setCelular('$celular'),
